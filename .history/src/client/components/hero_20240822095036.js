...
import * as userControls from "./UserControls.js";
...
export const mediaHero = {
  render: (hero) => {
    ...
    const sectionControl = userControls.sectionControl.render(hero);
    const sectionControlHTML = sectionControl.outerHTML; // Convert DOM object to string
    ...
    return `    
        ...
        <div class="ink03 tags">
            ${detailSnippet}
        </div>${sectionControlHTML} // Use the stringified DOM object
    `;
  },
};
