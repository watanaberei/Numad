  ...
  render: (store) => {
    return `
        <div class="store-controls">
          ...
          <button class="store-controls" id="storeControls-save" onclick="saveStore('${store.headlineText}')">
            <i class="icon-action-save-12px"></i>
            <span class="text03">Save</span>
          </button>
          <button class="store-controls" id="storeControls-checkin" onclick="checkInStore('${store.headlineText}')">
