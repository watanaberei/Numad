  ...
  render: (store) => {
    ...
    <div class="user-controls">
      ...
      <div class="stamp">
        ...
        <div id="userImpression" class="impression">
            <button class="impression-button like" onclick="window.ImpressionHandler.toggleImpression('${store.storeId}', 'like')">
            <i class="icon-user-rating-like-12px"></i>
            ${countDefault.render(count.countLike)}
            </button>

            <button class="impression-button dislike" onclick="window.ImpressionHandler.toggleImpression('${store.storeId}', 'dislike')">
