  ...
  render: (store) => {
    return `
        <div class="store-controls">
          <button class="store-controls" id="storeControls-share" onclick="shareStore('${store.storeURL}')">
            <i class="icon-action-share-12px"></i>
            <span class="text03">Share</span>
          </button>
          <button class="store-controls" id="storeControls-save" onclick="toggleSaveStore('${store.headlineText}')">
            <i class="icon-action-save-12px"></i>
            <span class="text03">Save</span>
          </button>
          <button class="store-controls" id="storeControls-checkin" onclick="toggleCheckInStore('${store.headlineText}')">
