    ...
    <div class="user-controls">
      ...
      <div class="stamp">
        ...
        <div id="userImpression" class="impression disabled">
          <button class="impression-button like" onclick="storeActions.toggleImpression('like')">
            <i class="icon-user-rating-like-12px"></i>
            ${countDefault.render(count.countLike)}
          </button>

          <button class="impression-button dislike" onclick="storeActions.toggleImpression('dislike')">
