  ...
  render: (store) => {
    return `
        <div class="store-controls">
          <button class="store-controls" id="storeControls-share">
            <i class="icon-action-share-12px"></i>
            <span class="text03">
              Share
            </span>
          </button>
          <button class="store-controls" id="storeControls-save">
            <i class="icon-action-save-12px"></i>
            <span class="text03">
              Save
            </span>
          </button>
          <button class="store-controls" id="storeControls-checkin">
