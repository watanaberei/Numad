                    ...
                    <div class="signup-header">
                        ...
                        <div class="signup-headline">
                              ...
                              <div class="title">
                                ...
                                <div id="setting-info" class="details">
                                ${setting.firstName && setting.lastName && setting.birthdate ? `
                                  <p>First Name: ${setting.firstName}</p>
                                  <p>Last Name: ${setting.lastName}</p>
                                  <p>Birthdate: ${setting.birthdate}</p>
                                ` : `
